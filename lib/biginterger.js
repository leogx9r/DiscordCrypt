...
global.bigInt = ( function () {
    ...
    function divMod1( a, b ) {
        ...
        let quotientDigit, shift, carry, borrow, i, l, q;
    ...
    const powers2Length = powersOfTwo.length, highestPower2 = powersOfTwo[ powers2Length - 1 ];
    ...
    function bitwise( x, y, fn ) {
        y = parseValue( y );
        const xSign = x.isNegative(), ySign = y.isNegative();
        let xRem = xSign ? x.not() : x,
            yRem = ySign ? y.not() : y;
        let xDigit = 0, yDigit = 0;
        let xDivMod = null, yDivMod = null;
        const result = [];
    ...
    function roughLOB( n ) {
        ...
        let v = n.value, x = typeof v === "number" ? v | LOBMASK_I : v[ 0 ] + v[ 1 ] * BASE | LOBMASK_BI;
        return x & -x;
    }
    ...
    let parseBase = function ( text, base ) {
    ...
    function parseBaseFromArray( digits, base, isNegative ) {
        let val = Integer[ 0 ], pow = Integer[ 1 ], i;
    ...
    function toBase( n, base ) {
        ...
        if ( base.equals( -1 ) ) {
            ...
            if ( n.isNegative() )
                return {
                    value: [ ].concat.apply( [], Array( ... Array( -n ) )
                        .map( Array.prototype.valueOf, [ 1, 0 ] )
                    ),
                    isNegative: false
                };

            const arr = Array( ... Array( +n - 1 ) )
